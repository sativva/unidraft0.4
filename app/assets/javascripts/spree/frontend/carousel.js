$(document).ready(function() {
  ...
  ;(function(factory){
    ...
    Zippy.prototype.build = function(){
      var $indicators = this.$el.append('<ul class="indicators hidden" >').find('.indicators');
    ...
    Zippy.prototype.events = function(){
      $('body')
        .on('click touch swipe',this.settings.arrowRight,{direction:'right'},this.changeSlide)
        .on('click touch swipe',this.settings.arrowLeft,{direction:'left'},this.changeSlide)
        .on('click touch swipe','.indicators li',this.changeSlide);
    };
  ...
  if ($(window).width() < 768) {
    var draft_args = {
      arrowRight : '#draft-carousel .arrow-right', //A jQuery reference to the right arrow
      arrowLeft : '#draft-carousel .arrow-left', //A jQuery reference to the left arrow
      speed : 1000, //The speed of the animation (milliseconds)
      slideDuration : 10000 //The amount of time between animations (milliseconds)
    };
    $('#draft-carousel .carousel').Zippy(draft_args);

    var designer_args = {
      arrowRight : '#designers-carousel .arrow-right', //A jQuery reference to the right arrow
      arrowLeft : '#designers-carousel .arrow-left', //A jQuery reference to the left arrow
      speed : 1000, //The speed of the animation (milliseconds)
      slideDuration : 10000 //The amount of time between animations (milliseconds)
    };

    $('#designers-carousel .carousel').Zippy(designer_args);
     ...
     var draft_args = {
       ...
       arrowLeft : '#draft-carousel .arrow-left', //A jQuery reference to the left arrow
       speed : 1000, //The speed of the animation (milliseconds)
       slideDuration : 40000 //The amount of time between animations (milliseconds)
     };
