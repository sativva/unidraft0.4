...
ActiveRecord::Schema.define(version: 20170531113539) do
  ...
  create_table "spree_designers", force: :cascade do |t|
    t.string   "lastname"
    t.string   "givenname"
    t.string   "school"
    t.string   "linkedin"
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.date     "date_of_sale"
    t.string   "date_end_sale"
    t.integer  "min_sales_for_prod"
    ...
    t.index ["designer_id"], name: "index_spree_products_on_designer_id", using: :btree
